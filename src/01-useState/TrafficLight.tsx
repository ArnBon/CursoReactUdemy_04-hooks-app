...
// type TrafficLightColor = 'red' | 'yellow' | 'green'; //asi se puede hacer en forma digamos mas manual
type TrafficLightColor = keyof typeof colors; //asi se puede hacer en forma dinamica 
